    ...
    <div style={{ height: windowHeight }} className="mainDiv">
      ...
      <div className="mainHead">
        <InputFile
          ...
          options={options}
          isConfOn={isConfiguring}
        />
        <div className="Main_data">
          <img src={Logo} className="Logo" alt="Logo" />
          <h1 className="Main_data_Text Title">
            Web midi player/visualizer/recorder for piano
          </h1>
      ...
      <button className="Demo_Bt" onClick={PlayDemoMidi}>
        Play demo song
      </button>
      <NewOptions
        isOpened={isConfiguring}
